...
return [
     ...
     */
    'BBB_SECURITY_SALT'   => env('BBB_SECURITY_SALT', 'oHXlb7aKLqOhZSpEMcca0pwsA7zVwEevhmWpDkFNIA'),
    'BBB_SERVER_BASE_URL' => env('BBB_SERVER_BASE_URL', 'https://jtc-courses.com/bigbluebutton/'),
