...
class CertificatesController extends Controller
{
    ...
    public function certificates()
    {
        ...
        $textAR ="محمد محمود ابوالجود";
        $textEn ="Muhammed  AboElgoud";
        $textAR = $Arabic->utf8Glyphs($textAR); 
        $img = Image::make(public_path('images/certificate.jpeg')); 
        $img->text($textAR, 910, 280, function($font) {  
       ...
       $img->text($textEn, 320, 280, function($font) {  
        $font->file(public_path('fonts/ae_AlHor.ttf'));  
        $font->size(25);  
        $font->color('#000000');  
        $font->align('center');  
