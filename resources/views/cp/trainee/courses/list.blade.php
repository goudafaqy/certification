                                    ...
                                    <table id="dtBasicExample" class="table" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-info" href="{{route('trainee-courses-view',['id' => $course->id])}}" data-toggle="tooltip" data-placement="top" title="تفاصيل الدورة"><i style="position: relative; top: -2px; right: -4px" class="fa fa-building"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
