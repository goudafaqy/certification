                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-warning"  class="TraineeCourse" href="#" data="{{$item->course}}:{{ $item->national_id }}"   title="معاينة"><i style="position: relative; top: -2px; right: -4px" class="fa fa-eye"></i></a>
                                                </td>
                                                <td class="text-center">                                                  
