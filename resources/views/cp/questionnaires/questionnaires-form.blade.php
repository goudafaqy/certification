                    ...
                    <div class="card">
                        <div class="widget-header">
                            <div class=" d-flex justify-content-between align-items-center">
                                <h3 class="widget-title">إضافة إستبيان</h3>
                            </div>
                        </div>
                        <div class="card-body" style="padding: 0 15px">
                            ...
                            @endif
                            <form id="add-classification-form" action="{{ route('save-questionnaires') }}"
                                  method="POST">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required class="form-control @error('name') is-invalid @enderror"
                                                   id="name"
                                                   name="name" value="{{old('name', @$questionnaire->name)}}"
                                                   type="text">
                                        </div>
                                        @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text icon-dates" id="basic-addon1">
                                                        <i class="fas fa-calendar-week"></i></span>
                                                </div>
                                                <input class="form-control  @error('publish_date') is-invalid @enderror"
                                                       id="publish_date" name="publish_date"
                                                       value="{{old('publish_date', @$questionnaire->publish_date)}}"
                                                       type="date"
                                ...
                                <div class="text-right" id="questions-section">
...
<script>
    $(document).ready(function () {
        ...
        $("#publish_date").keypress(function () {
            $(".err-msg-publish_date").hide();
