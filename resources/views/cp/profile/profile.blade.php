                    ...
                    <div class="profile-card-body">
                        <div class="product-tabs">
                            ...
                            <nav>
                                <ul>
                                    <li class="tab1">
                                        <label for="tab1"> <img src="{{asset('images/man.png')}}" style="width: 22px"> الملف الشخصي</label>
                                    </li>
                                    <li class="tab2">
                                        <label for="tab2"> <img src="{{asset('images/school.png')}}" style="width: 20px"> الكورسات</label>
                                    </li>
                                    <li class="tab3">
                                        <label for="tab3"> <img src="{{asset('images/bo.png')}}" style="width: 22px"> البحوث والدراسات</label>
                                    </li>
                                    <li class="tab4">
                                        <label for="tab4"> <img src="{{asset('images/training.png')}}" style="width: 22px"> الخبرات</label>
                                    </li>
                                    <li class="tab5">
                                        <label for="tab5"> <img src="{{asset('images/certificate.png')}}" style="width: 22px"> الشهادات</label>
                                    </li>
                                </ul>
                            </nav>
                            <section>
                                <div class="tab1 Tab-form">
                                    <div class="container-login">
                                        <div class="wrap-login">
                                            <form class="login-forms" action="{{route('save-profile')}}" method="post">
                                                @csrf
                                                ...
                                                <div class=" input-group">
                                                    ...
                                                    <select id="gender" required="" name="gender" class="form-control form-control-lg">
                                            ...
                                            <div class="ui-input-container">
                                                <div data-repeater-list="group-a">
                                                    <div data-repeater-item>
                                                        <label class="ui-form-input-container">
                                                            <textarea class="ui-form-input" id="word-count-input"></textarea>
                                                            <span class="form-input-label"><img src="{{ asset('images/bo.png') }}" style="width: 22px"><span data-repeater-delete type="button" value="Delete" class="delet">&times;</span></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
