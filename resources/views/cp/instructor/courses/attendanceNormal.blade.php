                                ...
                                <table id="dtBasicExample" class="table course-table" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td class="priority text-center">{{ $attendance['attand'] == 1 ? "حاضر" : "غائب"}}</td>
                                            <td class="priority text-center">
                                                <div class="content-switch">
                                                    <label class="switch">
                                                        <input {{$attendance['attand'] == 1 ? "checked" : ""}}  type="checkbox"  sessionId="{{$attendance['SessionID']}}" userId="{{$attendance['user_id']}}" id="attend-{{$attendance['id']}}">
