                        ...
                        <div class="bg2">
                            ...
                            <div class="content-box" style="padding:2rem" id="result">
                                ...
                                <div class="box" style="margin-top:-5rem;">
                                    ...
                                    <p class="center">
									   <span class="font-40 negrito  quebra_linha" style="color: #538d51;  font-family:AL-Mohanad">شهادة حضور</span>
										...
										<h4 class="center" style="color: grey;margin-bottom:1.5rem;font-size: 30px; font-family:AL-Mohanad">@if($data['form']==3)والموثقات@endifضمن برنامج تأهيل الموثقين  </h4>
                                        <h4 style="color: grey;font-size: 24px;text-align: center; font-family:AL-Mohanad">المقامة خلال الفترة من <span> {{$data['fromDate']}} </span> <span> وحتى تاريخ</span><span>  {{$data['toDate']}}</span></h6>
                                    </p>
                                ...
                                <div class="bottom-text center" style="padding-bottom:0rem;">
                                    @if($data['form']==3)
                                     <h6 style="color: grey;font-size:24px;padding-right:1rem;font-size: 28px">   بواقع {{$data['hours']}} ساعة تدريبية   </h6>
                                    @elseif($data['form']==4)
                                    <h6 style="color: grey;font-size:24px;padding-right:1rem;font-size: 28px">   لمدة {{$data['days']}} أيام تدريبية   </h6>
                                    @endif
