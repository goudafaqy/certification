                                ...
                                <div class="box" style="margin-top:-5rem;">
                                    ...
                                    <p class="center">
									   <span class="font-40 negrito  quebra_linha" style="color: #538d51;  font-family:AL-Mohanad">{{trim($data['certification_title'])}} </span>
                                        ...
                                        <h4 class="center" style="color: grey;margin-bottom:1rem;font-size: 32px; font-family:AL-Mohanad">يشهد مركز التدريب العدلي  بأن</h4>
                                        ...
                                        <h5 class="" style="color: grey;text-align: center;margin-bottom:1rem;font-size: 27px; font-family:AL-Mohanad">هوية وطنية رقم <span> / </span>{{$data['national_id']}} </h5>
                                        <h4 class="center">
                                            <span style="color: grey;margin-bottom:1rem;font-size: 28px"> قد حضر@if($data['sex']==0)ت@endif {{trim($data['type'])}} </span>
