                                    ...
                                    <div class="row">
                                        ...
                                        @endif
                                            <div class=" input-group">
                                                ...
                                                <input id="national_id" required name="national_id" class="form-control input-login @error('national_id') is-invalid @enderror" value="{{ old('national_id') }}" type="text" placeholder="رقم الهوية" autocomplete="national_id" autofocus>
                                                @error('national_id')
