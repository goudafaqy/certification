                                ...
                                <div class="col-lg-3 col-sm-3">
                                    ...
                                    <div class="profile-card">
                                        <div class="card-header">
                                            ...
                                            <img class="profile-image" src="{{url($course->image != null?$course->image:'site-assets/images/2.jpg')}}" alt="">
                                            </a>
                                            <div class="profile-role"><a href="{{url('course/'.$course->id)}}">{{$course->title}}</a></div>
                                        ...
                                        <div class="card-body">
                                            <div class="contacts">
                                                <div class="flex">
                                                    <output dir="rtl" tabindex="0" role="slider" aria-readonly="true" aria-live="off" aria-valuemin="1" aria-valuemax="5" aria-valuenow="3" class="b-rating form-control align-items-center b-rating-inline form-control-sm d-inline-flex border-0 readonly" id="__BVID__107">
                                                    <span class="b-rating-star   b-rating-star-full">
                                                    <span class="profile_start">
                                                      @php($rating=App\Http\Helpers\RatingHelper::GetAvgRating($course->ratings))
                                                      @for ($i = 1; $i <= $rating; $i++)
                                                        ★
                                                      @endfor                                                      
                                                    </span>
                                                    </span><b aria-hidden="true" class="b-rating-value  ">
                                                    @if($rating==0)
                                                     لم يتم التقييم بعد
                                                    @else
                                                     {{$rating}}/5
