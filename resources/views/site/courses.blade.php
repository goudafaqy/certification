                            ...
                            <div class="col-sm-3">
                                <div class="course-item-wrapper">
                                    <div class="course-thumbnail">
                                        <a href="{{url('courses/'.$course->id)}}"><img src="{{asset($course->image != null?$course->image:'site-assets/images/2.jpg')}}" alt=""></a>
                                    ...
                                    <div class="thim-course-content">
                                            ...
                                            <div class="course-author-content">
                                                ...
                                                <div class="author-contain">
                                                    ...
                                                    <div class="value" itemprop="name">
                                                        <a href="{{url('courses/'.$course->id)}}">{{$course->instructor->name}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="course-meta">
                                            ...
                                            <span>
                              <i class="fa fa-tag"></i>
                              <a href="{{url('courses/'.$course->id)}}">{{$course->category->title}}</a>
                          </span>
